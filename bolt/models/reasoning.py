...
class Reasoning(nn.Module):
    ...
    def forward(self, dcl_op_list, img, ann, name_t, id_a, id_b, mode):
        '''
        ...
        exec = self.exec
        exec.init(img,ann, name_t, id_a, id_b, mode)
...
class Executor(nn.Module):
    ...
    def init(self,img, ann, name_t, id_a, id_b, mode):
        self.concept_matrix = self._make_concept_matrix(img,ann, mode)
        # print(concept_matrix)
    ...
    def _make_concept_matrix(self, img, ann, mode):
